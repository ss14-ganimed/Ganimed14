...
public sealed partial class CCVars
{
    ...
    public static readonly CVarDef<string> InfoLinksWebsite =
        CVarDef.Create("infolinks.website", "https://boosty.to/thundraboomerov", CVar.SERVER | CVar.REPLICATED); // Ganimed-Tweak
    ...
    public static readonly CVarDef<string> InfoLinksAppeal =
        CVarDef.Create("infolinks.appeal", "https://discord.gg/uPc4ZFFUJ7", CVar.SERVER | CVar.REPLICATED); // Ganimed-Tweak: Ссылка на обжалование
