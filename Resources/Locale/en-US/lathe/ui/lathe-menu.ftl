...
lathe-menu-alert-level-required = Alert level required: { $level }
lathe-menu-alert-level-current = Current level: { $level }
lathe-menu-alert-level-green = Green
lathe-menu-alert-level-blue = Blue
lathe-menu-alert-level-violet = Violet
lathe-menu-alert-level-yellow = Yellow
lathe-menu-alert-level-red = Red
lathe-menu-alert-level-gamma = Gamma
lathe-menu-alert-level-delta = Delta
lathe-menu-alert-level-epsilon = Epsilon
lathe-menu-alert-level-amber = Amber
lathe-menu-alert-level-altdelta = Alt-Delta
lathe-menu-alert-level-cascade = Cascade
