...
lathe-menu-alert-level-required = Требуется уровень угрозы: { $level }
lathe-menu-alert-level-current = Текущий уровень: { $level }
lathe-menu-alert-level-green = зелёный
lathe-menu-alert-level-blue = синий
lathe-menu-alert-level-violet = фиолетовый
lathe-menu-alert-level-yellow = жёлтый
lathe-menu-alert-level-red = красный
lathe-menu-alert-level-gamma = гамма
lathe-menu-alert-level-delta = дельта
lathe-menu-alert-level-epsilon = эпсилон
lathe-menu-alert-level-amber = янтарный
lathe-menu-alert-level-altdelta = альт-дельта
lathe-menu-alert-level-cascade = каскад
