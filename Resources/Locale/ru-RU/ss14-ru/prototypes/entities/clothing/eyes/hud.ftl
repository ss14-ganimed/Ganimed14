...
ent-ClothingEyesHudOnionBeer = пивлуковые очки
    .desc = Очки из обжаренного в кляре лука, которые сканируют гуманоидов в поле зрения и предоставляют данные об их жажде и голоде.
ent-ClothingEyesHudMedOnion = медилуковый визор
    .desc = Медицинский визор из обжаренного в кляре лука.
ent-ClothingEyesHudMedOnionBeer = пивмедилуковый визор
    .desc = Визор из обжаренного в кляре лука, который сканирует гуманоидов в поле зрения и предоставляет точные данные о состоянии их здоровья, жажде и голоде.
...
ent-ClothingEyesHudOmni = омнилуковый визор
    .desc = Экспериментальный луковый окуляр, совмещающий в себе функционал всех существующих визоров.
