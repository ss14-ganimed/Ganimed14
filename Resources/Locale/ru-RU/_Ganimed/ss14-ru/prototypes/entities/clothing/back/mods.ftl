...
ent-ClothingModsuitBackRD = МОД научного руководителя
    .desc = Частный военный сапёрный костюм от Aussie Armory, предназначенный для исследований взрывчатых веществ. Громоздкий, но дорогой.
ent-ClothingModsuitBackMagnate = МОД капитана
