...
ent-ClothingHeadHatMortarboard = квадратная академическая шапочка
    .desc = Успешно скрывает лысину академиков, что пишут теорию, пока их аномалии взрываются. Это доказательство пережитого ада учёбы к сожалению совсем не гарантирует выживание в научном отделе.
