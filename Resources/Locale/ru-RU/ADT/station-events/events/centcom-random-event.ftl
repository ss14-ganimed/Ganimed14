...
centcom-random-event-sighting-7 = запрещено использование радиоканалов, а также раций, гарнитур и интеркомов, в секторе объявлен режим радиомолчания. Инженерно-технической команде надлежит отключить телекоммуникационные сервера станции. Нарушение данного закона приравнивается к нарушению статьи 401.
