...
centcom-random-event-sighting-2 = все члены экипажа должны носить { $clothing }. Нарушение данного закона приравнивается к нарушению статьи 201.
...
centcom-random-event-sighting-7 = запрещено использование радио-каналов, а также раций, гарнитур и интеркомов, в секторе объявлен режим радио-молчания. Инженерно-технической команде надлежит отключить телекоммуникационные сервера станции. Нарушение данного закона приравнивается к нарушению статьи 401.
centcom-random-event-sighting-8 = { $clothing } запрещены и должны быть изъяты службой безопасности. Нарушение данного закона приравнивается к нарушению статьи 201.
centcom-random-event-sighting-9 = запрещено использовать { $generator } для получения электроэнергии, так как отдел по технике безопасности признал данный источник энергии крайне опасным. Нарушение данного закона приравнивается к нарушению статьи 401.
...
centcom-random-event-sighting-11 = экипажу запрещено иметь на своём лице растительность. Нарушение данного закона приравнивается к нарушению статьи 106.
...
centcom-random-event-sighting-13 = запрещено применять клонирование к телам разумных существ ради эксперимента или в качестве метода возвращения к жизни, в связи с признанием клонирования слишком опасным и негуманным. Нарушение данного закона приравнивается к нарушению статьи 401.
...
centcom-random-event-sighting-16 = запрещено физическое передвижение методом { $movement }. Нарушение данного закона приравнивается к нарушению статьи 106.
