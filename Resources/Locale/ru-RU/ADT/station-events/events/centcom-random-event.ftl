...
centcom-random-event-sighting-13 = запрещено применять клонирование над разумными существами ради эксперимента или в качестве метода возвращения к жизни, в связи с признанием клонирование слишком опасным и негуманным. Нарушение данного закона приравнивается к нарушению статьи 401.
