...
reagent-desc-carpetium = Таинственный химикат, обычно поставляемый с планеты клоунов, который покрывает ковром всё, на что попадёт. Каким-то образом отфильтровывает ларпотоксин из кровеносной системы.
