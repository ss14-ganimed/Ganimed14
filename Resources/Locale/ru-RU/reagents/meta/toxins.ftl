...
reagent-name-carpotoxin = ларпотоксин
reagent-desc-carpotoxin = Высокотоксичный химикат, содержащийся в космических ларпах. Вызывает болезненное чувство жжения.
