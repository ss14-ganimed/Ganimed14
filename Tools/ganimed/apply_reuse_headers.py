...
# --- Configuration ---
CUTOFF_COMMIT_HASH = "8bc6168808c42a5a1b026b938a852d59aab2ee50"
LICENSE_BEFORE = "MIT"
...
def create_header(authors, license_id, comment_style):
    ...
    if suffix is None:
        ...
        if authors:
            ...
            lines.append(f"{prefix} SPDX-FileCopyrightText: Contributors to the Enterprise/Ganimed14 project")
        ...
        if authors:
            ...
            lines.append(f"SPDX-FileCopyrightText: Contributors to the Enterprise/Ganimed14 project")
