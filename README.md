...
Некоторые файлы содержат заголовки-комментарии в соответствии со [спецификацией REUSE](https://reuse.software/) или отдельные файлы (`license` или `attributions`) с информацией о лицензии, авторском праве и условиях повторного использования.
