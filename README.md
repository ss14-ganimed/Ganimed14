...
Некоторые файлы содержат заголовки-комментарии с информацией о лицензии и авторском праве в соответствии со [спецификацией REUSE](https://reuse.software/). Некоторые папки также содержат отдельные файлы `license` или `attributions` с информацией о лицензии и условиях повторного использования.

Организация-владелец проекта не претендует на право собственности на работы (включая код, модификации, ассеты или ресурсы), созданные иными авторами/репозиториями/проектами/третьими сторонами или оригинальными разработчиками Space Station.

Оригинальные авторы работ сохраняют за собой все авторские права на работы собственного авторства, что означает, что оригинальные авторы имеют право использовать и распространять работы собственного авторства по собственному усмотрению.
