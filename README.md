...
Условия лицензий на исходный код, источником которого являются иные авторы/репозитории/проекты должны соблюдаться наравне с условиями лицензии этого репозитория (проекта).
