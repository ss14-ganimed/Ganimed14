...
- Постоянное развитие благодаря движку [Robust Toolbox](https://github.com/space-wizards/RobustToolbox), написанном на C#.
...
2. Выберете папку с локальным репозиторием командой `cd Ganimed14` и запустите `RUN_THIS.py` для инициализации подмодулей и скачивания движка.
