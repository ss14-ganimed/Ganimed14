...
Содержимое, добавленное в этот репозиторий **после** коммита 8bc6168808c42a5a1b026b938a852d59aab2ee50 (`2 августа 2024 08:50:00 UTC`), распространяется по лицензии [**GNU Affero General Public License версии 3.0**](https://github.com/ss14-ganimed/Ganimed14/blob/master/LICENSE-AGPLv3.TXT), если не указано иное.

Содержимое, добавленное в этот репозиторий **до** коммита 8bc6168808c42a5a1b026b938a852d59aab2ee50 (`2 августа 2024 08:50:00 UTC`), распространяется по лицензии [**MIT**](https://github.com/ss14-ganimed/Ganimed14/blob/master/LICENSE-MIT.TXT), если не указано иное.
