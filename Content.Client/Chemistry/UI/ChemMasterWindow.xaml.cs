...
namespace Content.Client.Chemistry.UI
{
    ...
    public sealed partial class ChemMasterWindow : FancyWindow
    {
        ...
        private void UpdateBottleContents(ChemMasterBoundUserInterfaceState state)
        {
            ...
            var bottlePh = GetContainerPH(bottleInfo);

            // Header - volume and solution pH
            ...
            headerHBox.AddChild(new Label
            {
                Text = Loc.GetString("chem-master-window-fill-with-ph-label-text",
                    ("currentVolume", bottleInfo.CurrentVolume),
                    ("maxVolume", bottleInfo.MaxVolume),
                    ("ph", bottlePh.ToString("0.0"))),
        ...
        private string FormatReagentQuantityLabel(ReagentId reagent, FixedPoint2 quantity)
        {
            if (reagent != default && _prototypeManager.TryIndex(reagent.Prototype, out ReagentPrototype? proto))
            {
                return Loc.GetString("chem-master-window-quantity-with-ph-label-text",
                    ("quantity", quantity),
                    ("ph", proto.PH.ToString("0.0")));
            }

            return Loc.GetString("chem-master-window-quantity-label-text", ("quantity", quantity));
        }
        ...
        private Control BuildSimpleReagentRow(Color reagentColor, int rowCount, string name, FixedPoint2 quantity, ReagentId reagentId, bool addTransferButton = true)
        {
            ...
            var statsContainer = new BoxContainer
            {
                ...
                Children =
                {
                    ...
                    new Label
                    {
                        Text = FormatReagentQuantityLabel(reagentId, quantity),
                        StyleClasses = { StyleNano.StyleClassLabelSecondaryColor },
                        HorizontalAlignment = HAlignment.Left
                    }
                }
        ...
        private void UpdatePillContainerContents(ChemMasterBoundUserInterfaceState state)
        {
            ...
            var pillPh = GetContainerPH(pillInfo);

            // Header - volume and solution pH (same as bottles)
            var headerHBox = new BoxContainer
            {
                Orientation = LayoutOrientation.Horizontal
            };
            ...
            {
                Text = Loc.GetString("chem-master-window-fill-with-ph-label-text",
                    ("currentVolume", pillInfo.CurrentVolume),
                    ("maxVolume", pillInfo.MaxVolume),
                    ("ph", pillPh.ToString("0.0"))),
                StyleClasses = { StyleNano.StyleClassLabelSecondaryColor }
            });
        ...
        private void BuildBufferInfo(ChemMasterBoundUserInterfaceState state)
        {
            ...
            var bufferPh = state.BufferSolutionPH ?? ChemistryPH.NeutralPH;
            var bufferVol = new Label
            {
                Text = Loc.GetString("chem-master-window-buffer-volume-with-ph-label-text",
                    ("volume", state.BufferCurrentVolume ?? FixedPoint2.Zero),
                    ("ph", bufferPh.ToString("0.0"))),
        ...
        private void BuildContainerUI(Control control, ContainerInfo? info, bool addReagentButtons)
        {
            ...
            var containerPh = GetContainerPH(info);

            // Name of the container and its fill status (Ex: 44/100u, pH 7.0)
            control.Children.Add(new BoxContainer
            {
                ...
                Children =
                {
                    ...
                    {
                        Text = Loc.GetString("chem-master-window-fill-with-ph-label-text",
                            ("currentVolume", info.CurrentVolume),
        ...
        private Control BuildReagentRow(Color reagentColor, int rowCount, string name, ReagentId reagent, FixedPoint2 quantity, bool isBuffer, bool addReagentButtons, ChemMasterBoundUserInterfaceState? state = null)
        {
            ...
            var statsContainer = new BoxContainer
            {
                ...
                Children =
                {
                    ...
                    new Label
                    {
                        Text = FormatReagentQuantityLabel(reagent, quantity),
                        StyleClasses = { StyleNano.StyleClassLabelSecondaryColor },
                        HorizontalAlignment = HAlignment.Left
                    }
                }
